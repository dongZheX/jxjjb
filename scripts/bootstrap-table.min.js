    ...
    (function (l) {
        ...
        var s = {
            ...
            bootstrapVersion: i, sprintf: function (e) {
                ...
                try {
                    for (var n, s, l = e[Symbol.iterator](); !(o = (n = l.next()).done); o = !0) if (s = n.value, s.field === t) return s.title
                } catch (e) {
                    i = !0, a = e
                } finally {
                    try {
                ...
                for (var v = 0; v < e.length; v++) {
                    ...
                    try {
                        for (var g, f = e[v][Symbol.iterator](); !(c = (g = f.next()).done); c = !0) {
                            var b = g.value, r = b.rowspan || 1, m = b.colspan || 1, y = o[v].indexOf(!1);
                ...
                try {
                    for (var r, d, p = i[Symbol.iterator](); !(n = (r = p.next()).done); n = !0) if (d = r.value, a.includes(d) && e[d] !== t[d]) return !1
                } catch (e) {
                    s = !0, l = e
                } finally {
                    try {
                ...
                try {
                    for (var n, s = Object.entries(e)[Symbol.iterator](); !(t = (n = s.next()).done); t = !0) {
                        var l = n.value, r = a(l, 2), d = r[0], p = r[1],
                ...
                var a = t.split('.'), n = !0, s = !1, l = void 0;
                try {
                ...
                try {
                    for (var l, r = e.entries()[Symbol.iterator](); !(o = (l = r.next()).done); o = !0) {
                        var d = l.value, p = a(d, 2), c = p[0], i = p[1];
            ...
            return o(t, [{
                ...
                key: 'initLocale', value: function () {
                    if (this.options.locale) {
                        var e = l.fn.bootstrapTable.locales, t = this.options.locale.split(/-|_/);
                ...
                key: 'initTable', value: function () {
                    var e = this, o = [], i = [];
                    if (this.$header = this.$el.find('>thead'), this.$header.length || (this.$header = l('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el)), this.$header.find('tr').each(function (e, t) {
                        var a = [];
                        ...
                        this.$el.find('>tbody>tr').each(function (t, o) {
                            ...
                            n._id = l(o).attr('id'), n._class = l(o).attr('class'), n._data = r.getRealDataAttr(l(o).data()), l(o).find('>td').each(function (o, i) {
                                ...
                                for (var h = p; h < p + s; h++) for (var u = t; u < t + d; u++) a[u] || (a[u] = []), a[u][h] = !0;
                ...
                key: 'initHeader', value: function () {
                    ...
                    this.header = {
                        ...
                        var o = e.currentTarget, i = l(o).prop('checked');
                ...
                key: 'initSort', value: function () {
                    ...
                    -1 !== i && (this.options.sortStable && this.data.forEach(function (e, t) {
                        ...
                        var s = r.getItemField(n, t, e.options.escape), d = r.getItemField(a, t, e.options.escape),
                ...
                key: 'onSort', value: function (e) {
                    var t = e.type, o = e.currentTarget, i = 'keypress' === t ? l(o) : l(o).parent(),
                ...
                key: 'initToolbar', value: function () {
                    var e = this, t = [], o = 0, i = void 0, a = void 0, d = 0;
                ...
                key: 'onSearch', value: function (e) {
                    var t = e.currentTarget, o = e.firedByInitSearchText, i = l.trim(l(t).val());
                ...
                key: 'initSearch', value: function () {
                    ...
                    if ('server' !== this.options.sidePagination) {
                        ...
                        this.data = o ? this.options.data.filter(function (e) {
                            for (var t in o) if (Array.isArray(o[t]) && !o[t].includes(e[t]) || !Array.isArray(o[t]) && e[t] !== o[t]) return !1;
                            return !0
                ...
                key: 'initPagination', value: function () {
                    ...
                    var o = [], a = !1, n = void 0, i = void 0, d = void 0, p = void 0, c = void 0, h = void 0,
                        u = void 0, g = this.getData(), f = this.options.pageList;
                    ...
                    if (0 < this.totalPages && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages), this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1, this.pageTo = this.options.pageNumber * this.options.pageSize, this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows), o.push(r.sprintf('<div class="%s-%s pagination-detail">', s.classes.pull, this.options.paginationDetailHAlign), '<span class="pagination-info">', this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) : this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), '</span>'), !this.options.onlyInfoPagination) {
                        ...
                        var x = e(this.options.paginationPagesBySide / 2), S = function (e) {
                ...
                key: 'initRow', value: function (e, t) {
                    ...
                    if (!(-1 < r.findIndex(this.hiddenRows, e))) {
                        ...
                        if (p = r.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], p), p) {
                            ...
                            try {
                                for (var C, T = Object.entries(p)[Symbol.iterator](); !(S = (C = T.next()).done); S = !0) {
                                    var O = C.value, _ = a(O, 2), R = _[0], I = _[1];
                        ...
                        return i.push('<tr', r.sprintf(' %s', c.length ? c.join(' ') : void 0), r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id), r.sprintf(' class="%s"', n.classes || (Array.isArray(e) ? void 0 : e._class)), ' data-index="' + t + '"', r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]), r.sprintf('%s', d), '>'), this.options.cardView && i.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'), !this.options.cardView && this.options.detailView && (i.push('<td>'), r.calculateObjectValue(null, this.options.detailFilter, [t, e]) && i.push('\n            <a class="detail-icon" href="#">\n            <i class="' + this.options.iconsPrefix + ' ' + this.options.icons.detailOpen + '"></i>\n            </a>\n          '), i.push('</td>')), this.header.fields.forEach(function (d, p) {
                            var h = '', u = r.getItemField(e, d, o.options.escape), g = '', f = '', b = {}, m = '',
                                y = o.header.classes[p], w = '', v = '', k = '', x = '', S = '', $ = o.columns[p];
                            if ((!o.fromHtml || 'undefined' != typeof u || $.checkbox || $.radio) && $.visible && (!o.options.cardView || $.cardVisible)) {
                                ...
                                if ($.checkbox || $.radio) {
                                    ...
                                    var q = $['class'] || '', c = !0 === g || u || g && g.checked,
                ...
                key: 'initBody', value: function (e) {
                    ...
                    for (var n = l(document.createDocumentFragment()), s = !1, d = this.pageFrom - 1; d < this.pageTo; d++) {
                        var i = o[d], p = this.initRow(i, d, o, n);
                    ...
                    s ? this.$body.html(n) : this.$body.html('<tr class="no-records-found">' + r.sprintf('<td colspan="%s">%s</td>', this.$header.find('th').length, this.options.formatNoMatches()) + '</tr>'), e || this.scrollTo(0), this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
                        var o = e.currentTarget, i = e.type, a = e.target, n = l(o), s = n.parent(),
                            d = t.data[s.data('index')], p = n[0].cellIndex, c = t.getVisibleFields(),
                            h = c[t.options.detailView && !t.options.cardView ? p - 1 : p],
                            u = t.columns[t.fieldsColumnsIndex[h]], g = r.getItemField(d, h, t.options.escape);
                        ...
                        i.preventDefault();
                        var e = l(i.currentTarget), a = e.parent().parent(), n = a.data('index'), s = o[n];
                        if (a.next().is('tr.detail-view')) e.find('i').attr('class', r.sprintf('%s %s', t.options.iconsPrefix, t.options.icons.detailOpen)), t.trigger('collapse-row', n, s, a.next()), a.next().remove(); else {
                        ...
                        if (i) {
                            ...
                            var n = t.header.fields[o], s = t.getVisibleFields().indexOf(n);
                            if (-1 !== s) {
                                t.options.detailView && !t.options.cardView && (s += 1);
                                var d = function (e, o) {
                                    t.$body.find('>tr:not(.no-records-found)').each(function (a, i) {
                                        var r = l(i), d = r.find(t.options.cardView ? '.card-view' : 'td').eq(s),
                                            p = e.indexOf(' '), c = e.substring(0, p), h = e.substring(p + 1);
                                        d.find(h).off(c).on(c, function (i) {
                                            var e = r.data('index'), a = t.data[e], s = a[n];
                                            o.apply(t, [i, s, a, e])
                                        })
                                    })
                                }, p = !0, c = !1, h = void 0;
                                try {
                                    for (var u, g = Object.entries(i)[Symbol.iterator](); !(p = (u = g.next()).done); p = !0) {
                                        var f = u.value, b = a(f, 2), m = b[0], y = b[1];
                                        d(m, y)
                                    }
                                } catch (e) {
                                    c = !0, h = e
                ...
                key: 'initServer', value: function (e, t, o) {
                    var i = this, a = {}, n = this.header.fields.indexOf(this.options.sortName), s = {
                                ...
                                if (c = r.sprintf('text-align: %s; ', p.falign ? p.falign : p.align), h = r.sprintf('vertical-align: %s; ', p.valign), g = r.calculateObjectValue(null, this.options.footerStyle), g && g.css) {
                                    ...
                                    try {
                                        for (var w, v = Object.keys(g.css)[Symbol.iterator](); !(b = (w = v.next()).done); b = !0) {
                                            var k = w.value, x = a(k, 2), S = x[0], $ = x[1];
                                            u.push(S + ': ' + $)
                                        }
                                    } catch (e) {
                                        m = !0, y = e
                ...
                key: 'fitFooter', value: function () {
                    ...
                    var e = this.$el.css('width'), t = e > this.$tableBody.width() ? r.getScrollBarWidth() : 0;
                    this.$tableFooter.css({"margin-right": t}).find('table').css('width', e).attr('class', this.$el.attr('class'));
                ...
                key: 'updateByUniqueId', value: function (e) {
                    var t = Array.isArray(e) ? e : [e], o = !0, i = !1, a = void 0;
                    try {
                        for (var n, s, r = t[Symbol.iterator](); !(o = (n = r.next()).done); o = !0) if (s = n.value, s.hasOwnProperty('id') && s.hasOwnProperty('row')) {
                            var d = this.options.data.indexOf(this.getRowByUniqueId(s.id));
                            -1 !== d && l.extend(this.options.data[d], s.row)
                        }
                    } catch (e) {
                        i = !0, a = e
                    } finally {
                ...
                key: 'getHiddenRows', value: function (e) {
                    ...
                    var t = this.getData(), o = [], i = !0, a = !1, n = void 0;
                    try {
                ...
                key: 'expandAllRows', value: function (e) {
                    var t = this;
                    if (e) {
                        var o = this.$body.find(r.sprintf('> tr[data-index="%s"]', 0)), a = null, n = !1, s = -1;
                    ...
                    } else for (var d = this.$body.children(), p = 0; p < d.length; p++) this.expandRow_(!0, l(d[p]).data('index'))
                }
            }, {
                key: 'collapseAllRows', value: function (e) {
                    if (e) this.expandRow_(!1, 0); else for (var t = this.$body.children(), o = 0; o < t.length; o++) this.expandRow_(!1, l(t[o]).data('index'))
                }
            }, {
